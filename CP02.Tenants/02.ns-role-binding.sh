...
kubectl -n org02 create rolebinding org02-view-all --clusterrole=view --group=group02
...
kubectl -n org03 create rolebinding org03-view-all --clusterrole=view --group=group03
...
kubectl -n org04 create rolebinding org04-view-all --clusterrole=view --group=group04
...
kubectl -n org05 create rolebinding org05-view-all --clusterrole=view --group=group05
